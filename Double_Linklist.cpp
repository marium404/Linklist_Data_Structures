...
int main(){
	...
	cout << "\t\t\t****DOUBLE LINKLIST****\n";
	cout << "\t1: Create list\n";																		
	cout << "\t2: Insert new node at start\n";			
	cout << "\t3: Insert node at the end\n";	
	cout << "\t4: Insert the node in specific position\n";				
	cout << "\t5: Search user given value in list\n";	
	cout << "\t6: Count number of elements greater than user given number\n";
	cout << "\t7: Delete first node\n";								
	cout << "\t8: Delete element from last\n";		
	cout << "\t9: Delete from specific position\n";
	cout << "\t10: Display values of list\n";			
	cout << "\t11: Exit\n";
	cout << "\t\t-------------------\n";
	...
	switch(a)
	{
		case 1:
			...
			cout << "Enter data to list:\n";
			cin >> n;
			create_list(n);
			
			
			cout << "List has being created\n";
			display();
			break;
